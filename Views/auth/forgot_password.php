...
<head>
    ...
    <title>Forgot Password - Real-Time Stock Tracker</title>
    <!-- Bootstrap 5 CSS -->
...
<body>
    ...
    <div class="forgot-card">
        ...
        <h4 class="text-center mb-2 font-weight-bold">Reset Password</h4>
        <p class="text-center text-muted small mb-4">Enter your email and we'll send you a link to reset your password.</p>
        ...
        <div class="login-link">
            Remembered your password? <a href="<?= base_url('login') ?>">Sign In</a>
        </div>
    </div>
